...
var testSetModelTbl = []struct {
	...
	// No change for different types
	{json.RawMessage(`{"ref":{"rid":"test.ref"}}`), json.RawMessage(`{"ref":{"rid":"test.ref"}}`), nil},
	{json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), nil},
	{json.RawMessage(`{"data":{"data":{"foo":42}}}`), json.RawMessage(`{"data":{"data":{"foo":42}}}`), nil},
	{json.RawMessage(`{"data":{"data":"foo"}}`), json.RawMessage(`{"data":{"data":"foo"}}`), nil},
	{json.RawMessage(`{"data":{"data":"foo"}}`), json.RawMessage(`{"data":"foo"}`), nil},
	{json.RawMessage(`{"data":"foo"}`), json.RawMessage(`{"data":{"data":"foo"}}`), nil},
	...
	{json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), json.RawMessage(`{"ref":{"rid":"test.mod","soft":true}}`), json.RawMessage(`{"ref":{"rid":"test.mod","soft":true}}`)},
	{json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), json.RawMessage(`{"ref":{"rid":"test.ref"}}`), json.RawMessage(`{"ref":{"rid":"test.ref"}}`)},
	{json.RawMessage(`{"ref":{"rid":"test.ref"}}`), json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`)},
	{json.RawMessage(`{"data":{"data":{"foo":42}}}`), json.RawMessage(`{"data":{"data":{"bar":42}}}`), json.RawMessage(`{"data":{"data":{"bar":42}}}`)},
	{json.RawMessage(`{"data":{"data":{"foo":42}}}`), json.RawMessage(`{"data":{"data":{"foo":43}}}`), json.RawMessage(`{"data":{"data":{"foo":43}}}`)},
	{json.RawMessage(`{"data":{"data":"foo"}}`), json.RawMessage(`{"data":"bar"}`), json.RawMessage(`{"data":"bar"}`)},
	{json.RawMessage(`{"data":"foo"}`), json.RawMessage(`{"data":{"data":"bar"}}`), json.RawMessage(`{"data":"bar"}`)},
	...
	{json.RawMessage(`{}`), json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`)},
	{json.RawMessage(`{}`), json.RawMessage(`{"data":{"data":{"foo":42}}}`), json.RawMessage(`{"data":{"data":{"foo":42}}}`)},
	{json.RawMessage(`{}`), json.RawMessage(`{"data":{"data":"foo"}}`), json.RawMessage(`{"data":"foo"}`)},
	...
	{json.RawMessage(`{"ref":{"rid":"test.ref","soft":true}}`), json.RawMessage(`{}`), json.RawMessage(`{"ref":{"action":"delete"}}`)},
	{json.RawMessage(`{"data":{"data":{"foo":42}}}`), json.RawMessage(`{}`), json.RawMessage(`{"data":{"action":"delete"}}`)},
	{json.RawMessage(`{"data":{"data":"foo"}}`), json.RawMessage(`{}`), json.RawMessage(`{"data":{"action":"delete"}}`)},
}
